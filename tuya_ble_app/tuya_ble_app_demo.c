...
static const char auth_key_test[] = "pFtOfsEIZxAvTAEBXR3c8N8o7G98eo4M";
static const char device_id_test[] = "tuya25f59f0607df";
static const uint8_t mac_test[6] = {0x9A,0x6F,0x31,0x4D,0x23,0xDC}; //The actual MAC address is : DC234D316F9A
